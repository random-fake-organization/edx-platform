...
class FeatureEnabledTestCase(TestCase):
    ...
    def test_auto_certificate_generation_enabled_for_course(
        ...
        with configure_waffle_namespace(self_paced_enabled, instructor_paced_enabled):
            self.assertEqual(expected_value, api.auto_certificate_generation_enabled_for_course(is_self_paced))
    ...
    @ddt.unpack
    def test_can_validate_certificate_available_date_field(
            self, self_paced_enabled, instructor_paced_enabled, is_self_paced, expected_value
    ):
        with configure_waffle_namespace(self_paced_enabled, instructor_paced_enabled):
            self.assertEqual(expected_value, api.can_validate_certificate_available_date_field(is_self_paced))
    ...
    def test_can_show_certificate_available_date_field(
        ...
        with configure_waffle_namespace(self_paced_enabled, instructor_paced_enabled):
            self.assertEqual(expected_value, api.can_show_certificate_available_date_field(is_self_paced))
